...
export const translations = {
  ja: {
    ...
    "profile.changeEmail": "メールアドレスの変更",
    "profile.newEmail": "新しいメールアドレス",
    "profile.emailChangeSuccessDirect": "メールアドレスを更新しました。次回ログイン時から新しいアドレスを使用してください。",
    "profile.emailChangeSent": "新しいメールアドレス宛てに確認コードを送信しました。確認コードを入力してください。",
    "profile.verificationCode": "確認コード (6桁)",
    "profile.confirmChange": "変更を確定する",
    "profile.requestChange": "変更リクエストを送信",
    "profile.cancelChange": "キャンセル",
    "profile.changeEmailHelp": "※メール送信が設定されている場合は、新しいアドレス宛てに確認コードが送信されます。設定されていない場合は、現在のパスワード確認のみで即時更新されます。",
    ...
    "workspace.inviting": "招待メール送信中...",
    "workspace.pending": "招待中",
    "workspace.reinvite": "再招待",
    "workspace.reinviting": "再招待送信中...",
    "workspace.reinviteSuccess": "再招待が完了しました",
    "workspace.reinviteConfirm": "このユーザーに再招待メールを送信し、初期パスワードを再発行しますか？",
    "workspace.add": "追加",
  ...
  en: {
    ...
    "profile.emailChangeSuccessDirect": "Email address updated. Please use the new email address next time you log in.",
    "profile.emailChangeSent": "A verification code has been sent to your new email address. Please enter the code below.",
    "profile.verificationCode": "Verification Code (6 digits)",
    "profile.confirmChange": "Confirm Change",
    "profile.requestChange": "Request Change",
    "profile.cancelChange": "Cancel",
    "profile.changeEmailHelp": "If email sending is configured, a verification code will be sent to the new address. Otherwise, it will be updated immediately after verifying your current password.",
    ...
    "workspace.inviting": "Sending invitation email...",
    "workspace.pending": "Pending",
    "workspace.reinvite": "Re-invite",
    "workspace.reinviting": "Resending invite...",
    "workspace.reinviteSuccess": "Re-invitation sent successfully",
    "workspace.reinviteConfirm": "Resend invitation email and issue a new temporary password for this user?",
    "workspace.add": "Add",
